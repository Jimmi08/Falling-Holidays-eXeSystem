...
if(ADMIN_AREA) {
	...
	if (vartrue($pluginpref['SnowActive']) && $pluginpref['snowType'] == 'snowstorm')
	{
		$jscode = '';
		if (vartrue($pluginpref['snowExcludeMobile']))
		{
			$jscode .= " snowStorm.excludeMobile = true; ";}
		else
		{
			$jscode .= " snowStorm.excludeMobile = false; ";}
		;
		if (vartrue($pluginpref['snowAutoStart']))
		{
			$jscode .= " snowStorm.autoStart = true; ";}
		else
		{
			$jscode .= " snowStorm.autoStart = false; ";}
		;
		if (vartrue($pluginpref['snowsStick']))
		{
			$jscode .= " snowStorm.snowStick = true; ";}
		else
		{
			$jscode .= " snowStorm.snowStick = false; ";}
		;
		if (vartrue($pluginpref['snowMeltEffect']))
		{
			$jscode .= " snowStorm.useMeltEffect = true; ";}
		else
		{
			$jscode .= " snowStorm.useMeltEffect = false; ";}
		;
		if (vartrue($pluginpref['snowTwinkleEffect']))
		{
			$jscode .= " snowStorm.useTwinkleEffect = true; ";}
		else
		{
			$jscode .= " snowStorm.useTwinkleEffect = false; ";}
		;
		if (vartrue($pluginpref['snowPositionFixed']))
		{
			$jscode .= " snowStorm.usePositionFixed = true; ";}
		else
		{
			$jscode .= " snowStorm.usePositionFixed = false; ";}
		;
		if (vartrue($pluginpref['snowFollowMouse']))
		{
			$jscode .= " snowStorm.followMouse = true; ";}
		else
		{
			$jscode .= " snowStorm.followMouse = false; ";}
		;
		if (vartrue($pluginpref['snowFreezeOnBlur']))
		{
			$jscode .= " snowStorm.freezeOnBlur = true; ";}
		else
		{
			$jscode .= " snowStorm.freezeOnBlur = false; ";}
		;
	...
	// 3D Snow
	if (vartrue($pluginpref['SnowActive']) && $pluginpref['snowType'] == 'snowthreed')
	{
