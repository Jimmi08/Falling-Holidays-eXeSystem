...
class fallingholidays_ui extends e_admin_ui
{
	...
	protected $prefs = array(
		...
		'LightsTag'			=> array('title' => 'HTML tag for insert lights code', 'tab' => 1,
		'help' => 'For example body .class #selector', 	    
		'type' => 'text', 		'data'=>'str',  'writeParms'=>'type=datetime',	'width' => 'auto', 	'thclass' => '', 				'class' => null, 		'nosort' => false),
		'LightsStart'			=> array('title' => LAN_START, 'tab' => 1,	    'type' => 'datestamp', 'data'=>'int',  'writeParms'=>'type=datetime',	'width' => 'auto', 	'thclass' => '', 				'class' => null, 		'nosort' => false),
		'LightsEnd'				=> array('title' => LAN_END, 'tab' => 1,		'type' => 'datestamp',  'data'=>'int',  'writeParms'=>'type=datetime',	'width' => 'auto', 	'thclass' => '', 				'class' => null, 		'nosort' => false),
